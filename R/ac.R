...
#' @param step A number that defines the time step length (s) between consecutive detections. The series are rounded to the nearest \code{step} to ensure alignment (see Details). `Duplicate' detections (of the same individual at the same receiver in the same step) are dropped.
