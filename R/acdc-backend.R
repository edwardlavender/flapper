...
#' @title Back-end implementation of the AC* algorithms
#' @description This function is the back-end of the AC, ACDC, ACPF and ACDCPF algorithms.
  ...
  function(
    ...
    if(check){
      ...
      if(!is.null(detection_kernels)) {
        ...
        # Define 'uniform' detection probability across study area if detection kernels un-supplied
    ...
    for(timestep_detection in seq_along(1:(nrow(acoustics)-1))){
      ...
      for(timestep_archival in 1:lpos){
        ...
        #### Define uniform probabilities across study site, if detection kernels un-supplied
